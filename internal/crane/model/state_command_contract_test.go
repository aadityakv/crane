...
func TestStateCommandContractV1PinsCompleteReplicatedDedupContract(t *testing.T) {
	want := StateCommandContract{
		...
		MaxTasksPerJob: 1024, MaxManifestsPerJob: 256, MaxReassignmentMarks: 1536, MaxInvalidations: 65535,
		...
		WorkerRecordBytes: 95, JobRecordFixedBytes: 117, AssignmentTokenBytes: 86,
		ResultReplicaBytes: 56, ReassignmentBytes: 60, InvalidationBytes: 158, SourceEOFEntryBytes: 36,
		CheckpointEntryBytes: 36, ManifestEntryBytes: 243, FailureBytes: 194, WorkerEventBytes: 58,
		Rules: []string{
...
func TestCanonicalStateCommandContractBytesChangeForEveryDefiningField(t *testing.T) {
	...
	mutations := []func(*StateCommandContract){
		...
		func(c *StateCommandContract) { c.MaxInvalidations++ },
		...
		func(c *StateCommandContract) { c.InvalidationBytes++ },
...
func TestStateCommandContractPinsEveryTask10CommandAndNestedRecord(t *testing.T) {
	...
	wantKinds := []string{
		...
		"SealManifest=12", "TransitionJob=13", "FailJob=14", "MarkManifestLost=15",
	}
