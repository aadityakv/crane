...
func TestWorkerControlContractV1IsOwnedAndPinsEveryConsensusRule(t *testing.T) {
	...
	schemas := []string{
		"NodeID:u16,WorkerEpoch:WorkerEpoch,ConsensusFingerprint:sha256,RegistryFingerprint:sha256", "NodeID:u16,WorkerEpoch:WorkerEpoch,SlotCapacity:u16,ConsensusFingerprint:sha256,RegistryFingerprint:sha256", "CoordinatorEpoch:CoordinatorEpoch", "NodeID:u16,WorkerEpoch:WorkerEpoch,CoordinatorEpoch:CoordinatorEpoch",
